...
class Database {
    ...
    async setAnnouncement(aid, name, content, icon, uid, published, until, global, notified, related_event){
        ...
        if(existing_announcement.success && existing_announcement.data.length > 0){
            ...
            if(related_event == null) related_event = announcement.related_event
            ...
            return this.edit("UPDATE announcements SET name = '" + name + "', content = '" + content + "', icon = '" + icon + "', uid = " + uid + ", published = '" + published + "', until = '" + until + "', global = '" + global + "', notified = '" + notified + "', related_event = " + related_event + " WHERE aid = " + aid)
        }
        ...
        return this.edit("INSERT INTO announcements (name, content, icon, uid, published, until, global, notified, related_event) VALUES ('" + name + "', '" + content + "', '" + icon + "', " + uid + ", '" + published + "', '" + until + "', '" + global + "', '" + notified + "', " + related_event + ") RETURNING *")
    }   
