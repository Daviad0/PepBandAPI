...
class Database {
    ...
    async verifySchema(){
        ...
        */
        ...
        await this.query("CREATE TABLE IF NOT EXISTS announcements (aid INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, name VARCHAR, content VARCHAR, icon VARCHAR, uid INT, published TIMESTAMP, until TIMESTAMP, global BOOLEAN, notified BOOLEAN)")
    ...
    async setAnnouncement(aid, name, content, icon, uid, published, until, global, notified){
        ...
        if(existing_announcement.success && existing_announcement.data.length > 0){
            ...
            return this.edit("UPDATE announcements SET name = '" + name + "', content = '" + content + "', icon = '" + icon + "', uid = " + uid + ", published = '" + published + "', until = '" + until + "', global = '" + global + "', notified = '" + notified + "' WHERE aid = " + aid)
        }
        ...
        return this.edit("INSERT INTO announcements (name, content, icon, uid, published, until, global, notified) VALUES ('" + name + "', '" + content + "', '" + icon + "', " + uid + ", '" + published + "', '" + until + "', '" + global + "', '" + notified + "') RETURNING *")
    }   
