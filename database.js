...
class Database {
    ...
    async verifySchema(){
        ...
        */
        ...
        await this.query("CREATE TABLE IF NOT EXISTS identity_management (uid INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, full_name VARCHAR, rid INT, last_seen TIMESTAMP, mtu_based BOOLEAN, mtu_id VARCHAR, mtu_uid VARCHAR, email VARCHAR)")
        ...
        */
        ...
        await this.query("CREATE TABLE IF NOT EXISTS identity_management_roles (rid INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, name VARCHAR, permission INT, updated TIMESTAMP, description VARCHAR)")
        ...
        */
        ...
        await this.query("CREATE TABLE IF NOT EXISTS groups (gid INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, name VARCHAR, icon VARCHAR, description VARCHAR, uid_primary INT, extra_data VARCHAR)")
